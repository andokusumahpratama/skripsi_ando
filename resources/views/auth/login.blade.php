            ...
            <div class="container-fluid p-0">
                <div class="card" style="background-color: rgba(245, 245, 245, 0.3);">
                    <div class="card-body">
                        ...
                        <h2 class="text-white text-center font-size-24"><b>Sign In</b></h2>
                        ...
                        <div class="p-3">
                            <form method="POST" class="form-horizontal mt-3" action="{{ route('login') }}">
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input id="email" name="email" class="form-control input" type="email" required="" placeholder="Username">
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input id="password" name="password" class="form-control input" type="password" required="" placeholder="Password">
